...
# Ora puoi stamparle affiancate correttamente!
# (Assicurati di aver fatto girare anche il blocco 4 della mappa dell'ascensore)
library(patchwork)
print(mappa_residui_mgwr + mappa_coef_ascensore)
